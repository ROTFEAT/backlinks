...
# 附录三：新发现的目录网站（2026-03-25 WebSearch 验证）

> 通过网络搜索发现的 20 个不在原始列表中的产品/AI 目录，全部经过 WebSearch 逐个验证。

## 必做（免费 + Dofollow + 高DR）

### Crunchbase (crunchbase.com)
- **DR**: 90+ | **费用**: 免费 | **类型**: 创业公司数据库
- **提交入口**: https://www.crunchbase.com/ → 注册后 Create Profile
- **链接属性**: **Dofollow**
- **备注**: 全球最大创业公司数据库，DR 极高，SEO 价值最大。仅接受科技生态相关内容。

### TinyLaunch (tinylaunch.com)
- **DR**: 71 | **费用**: 免费 | **类型**: 产品发布
- **提交入口**: https://www.tinylaunch.com/
- **链接属性**: **Dofollow**
- **备注**: 每周发布一次，Top 3 获得徽章。DR 71 免费 dofollow，性价比极好。

### Open Launch (open-launch.com)
- **DR**: 65 | **费用**: 免费 | **类型**: 产品发布
- **提交入口**: https://open-launch.com/
- **链接属性**: **Dofollow**
- **备注**: 开源 Product Hunt 替代品，有排队机制。

### DevHunt (devhunt.org)
- **DR**: 62 | **费用**: 免费 | **类型**: 开发者工具
- **提交入口**: https://devhunt.org/ （通过 GitHub PR 提交）
- **链接属性**: **Dofollow**
- **备注**: 专注开发者工具，需 GitHub 账号登录。

### MicroLaunch (microlaunch.net)
- **DR**: 58 | **费用**: 免费 | **类型**: 微型SaaS
- **提交入口**: https://microlaunch.net/
- **链接属性**: **Dofollow**
- **备注**: 提交后 30 天持续曝光，专注微型SaaS和独立开发者。

### OpenHunts (openhunts.com)
- **DR**: 50 | **费用**: 免费 | **类型**: 产品发布
- **提交入口**: https://openhunts.com/projects/submit
- **链接属性**: **Dofollow**
- **备注**: 2分钟提交，零摩擦，转化率 14.3%。

### Crozdesk (crozdesk.com)
- **DR/DA**: 44 | **费用**: 免费 | **类型**: SaaS评测
- **提交入口**: https://crozdesk.com/claims/new
- **链接属性**: **Dofollow**
- **备注**: 48小时审核，AI评分系统（CrozScore），自动参与年度 Software Awards。

## AI Tool 目录（新兴分类）

### Futurepedia (futurepedia.io)
- **DR**: 70+ | **费用**: 免费（Verified $497） | **类型**: AI工具目录
- **提交入口**: https://www.futurepedia.io/submit-tool
- **链接属性**: **Dofollow**
- **备注**: #1 AI 工具合集，月访问 40万+。免费基础收录即可。

### TopAI.tools (topai.tools)
- **费用**: 免费（Fast Track $39） | **类型**: AI工具排名
- **提交入口**: https://topai.tools/submit
- **链接属性**: **Dofollow**
- **备注**: 22000+ 工具，月访问 100万+。$39 Fast Track 性价比最好。

### There's An AI For That (theresanaiforthat.com)
- **DR**: 80+ | **费用**: $347 | **类型**: 最大AI目录
- **提交入口**: https://theresanaiforthat.com/submit/
- **链接属性**: Nofollow
- **备注**: 8000万用户，费用高但流量最大。每月X上有免费机会。

### AI Tools Directory (aitoolsdirectory.com)
- **费用**: 免费 | **类型**: AI分类目录
- **提交入口**: https://aitoolsdirectory.com/submit-tool
- **备注**: 人工审核分类。

### AI Directory (aidirectory.org)
- **费用**: 免费 | **类型**: AI目录
- **提交入口**: https://www.aidirectory.org/user-submit/
- **备注**: 细分分类（ML、网络安全AI、游戏AI等）。

### ToolPilot (toolpilot.ai)
- **费用**: 免费（需回链） | **类型**: AI导航
- **提交入口**: https://www.toolpilot.ai/pages/submit-your-ai-tool
- **备注**: 要求在自己网站放 ToolPilot badge 并回链。

### The Rundown AI (rundown.ai)
- **费用**: 免费 | **类型**: AI Newsletter + 目录
- **提交入口**: https://www.rundown.ai/submit
- **备注**: 背靠 100万+ 订阅者 Newsletter。

## 其他有价值的目录

### Peerlist (peerlist.io)
- **DR**: 76 | **费用**: 免费 | **类型**: 开发者社区
- **提交入口**: https://peerlist.io/signup → 添加项目
- **链接属性**: Nofollow
- **备注**: 类似技术版 LinkedIn，DR 高，品牌曝光好。

### LaunchIgniter (launchigniter.com)
- **DR**: 74 | **费用**: 免费 | **类型**: 产品发布
- **提交入口**: https://launchigniter.com/
- **链接属性**: Nofollow
- **备注**: 支持从 Product Hunt 等平台导入。

### SaaS Mag (saasmag.com)
- **费用**: 免费（Guest Post） | **类型**: SaaS杂志
- **提交入口**: https://www.saasmag.com/contributions/
- **链接属性**: 可能 Dofollow
- **备注**: 文章投稿 1000-6000 字，AP Style。


---

# 新增网站详细操作指南（第一批：Product Launch + AI Tool 类）

# SEO 外链操作指南 — 第一批：Product Launch + AI Tool 类（20个）

> 最后更新：2026-03-25 | 所有信息均经 WebSearch 验证

---

## 1. DevHunt (devhunt.org)

**DA/DR**: DA31 / DR62 | **费用**: 免费（付费加速 $49） | **类型**: 开发者工具发布平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交开发者工具 | https://devhunt.org/ → 顶部「Submit your Dev Tool」按钮 | Dofollow | 高 |
| GitHub PR（开源贡献方式） | https://github.com/MarsX-dev/devhunt | Dofollow | 中 |

### 操作步骤

1. 访问 https://devhunt.org/
2. 点击右上角「Sign In」，使用 **GitHub 账号**登录（必须用 GitHub 认证，防止刷票）
3. 登录后点击顶部「Submit your Dev Tool」→「New Tool」
4. 填写以下信息：
   - **Logo**：产品 logo（清晰方形图）
   - **Tagline**：一句话描述产品功能
   - **Description**：详细描述（支持 Markdown）
   - **Website URL**：产品网址（此处即为 dofollow 外链）
   - **Screenshots**：产品截图（多张）
   - **Category & Tags**：选择匹配的分类和标签
   - **Social Links**：Twitter/GitHub 等社交链接
5. 选择发布选项：免费发布 或 付费 $49 获得置顶曝光
6. 提交后等待审核，通过后自动上线

### Tips

- **必须用 GitHub 账号登录**，邮箱/Google 登录无法提交
- 仅接受开发者工具类产品（API、SDK、CLI、基础设施服务等）
- 每日有投票排名，发布当天号召社区投票效果最好
- 开源项目也可通过 GitHub PR 方式直接提交到仓库，参考 CONTRIBUTING.md
- 月访问量约 2K，流量不大但 dofollow 链接 SEO 价值高

---

## 2. OpenHunts (openhunts.com)

**DA/DR**: DA15 / DR50 | **费用**: 免费 | **类型**: Product Hunt 替代品

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交项目 | https://openhunts.com/projects/submit | Dofollow | 中 |

### 操作步骤

1. 访问 https://openhunts.com/
2. 点击注册创建账号，完善个人资料
3. 点击顶部导航「Submit」或直接访问 https://openhunts.com/projects/submit
4. 填写以下信息：
   - **Product Name**：产品名称
   - **Tagline**：简短一句话描述
   - **Description**：详细产品介绍
   - **Website URL**：产品网址（dofollow 外链）
   - **Logo**：产品 logo
   - **Screenshots**：产品截图
   - **Founder Story**：创始人故事（可选但推荐）
5. 提交后等待审核发布

### Tips

- 完全免费，无付费选项
- DR50 的 dofollow 链接，性价比极高
- 月访问量约 129，流量较低但外链价值在
- 积极参与社区互动（评论、投票其他项目）可增加曝光
- 发布后在社交媒体分享链接，带动投票

---

## 3. MicroLaunch (microlaunch.net)

**DA/DR**: DA18 / DR58 | **费用**: 免费 / Premium $39/月 | **类型**: 微型 SaaS 发布平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交产品 | https://microlaunch.net/ → Submit 按钮 | Dofollow | 高 |
| Premium 付费发布 | https://microlaunch.net/premium | Dofollow (DR59+) | 高 |

### 操作步骤

1. 访问 https://microlaunch.net/
2. 注册账号并完善个人资料
3. 点击「Submit」或「Launch」按钮
4. 填写以下信息：
   - **Product Name**：产品名称
   - **Tagline**：简短描述
   - **Description**：详细介绍（突出产品价值）
   - **Website URL**：产品网址
   - **Logo & Screenshots**：产品视觉素材
   - **Category**：产品分类
5. 提交后进入 **30天持续展示**周期
6. 在展示期内收集反馈、评价和早期用户
...
- 免费版需排队等候发布；Premium ($39/月) 可跳过排队并获得置顶
- Premium 包含：跳过排队、2x 曝光加成、每日产品推荐位、4+ SEO 优化页面、DR59+ dofollow 外链
- 每月限 40 个 Premium 名额，可用优惠码「LAUNCH20」享 8 折
- 与 Product Hunt 不同，这里排名按月而非按天，产品有更长曝光窗口
- 适合微型 SaaS、独立开发者产品
- 月访问量约 2K，声称触达 320K+ 独立访客和 5.5M+ 产品展示

---

## 4. TinyLaunch (tinylaunch.com)

**DA/DR**: DA21 / DR71 | **费用**: 免费 | **类型**: 每周发布平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交产品 | https://www.tinylaunch.com/ → Submit 按钮 | Dofollow | 高 |

### 操作步骤

1. 访问 https://www.tinylaunch.com/
2. 注册账号并完善个人资料
3. 点击「Submit」按钮进入提交表单
4. 填写以下信息：
   - **Product Name**：产品名称
   - **Description**：产品描述
   - **Website URL**：产品网址（dofollow 外链）
   - **Logo**：产品 logo
   - **Screenshots**：产品截图
   - **Demo Video**（可选）：产品演示视频
5. 提交后等待每周发布周期

### Tips

- 完全免费，无付费选项
- **DR71 的 dofollow 链接**，在免费目录中属于顶级 SEO 价值
- 每周发布一批产品，非每日，每个产品获得更充分的曝光
- **每周 Top 3 产品**获得 TinyLaunch 徽章 + 额外 dofollow 外链
- 徽章可嵌入到产品网站作为社会证明
- 创始人 Christopher Woggon 运营，适合独立黑客（indie hacker）产品
- 月访问量约 87，流量极低但 DR71 外链价值极高

---

## 5. Open Launch (open-launch.com)

**DA/DR**: DA21 / DR65 | **费用**: 免费 / Premium $12 / SEO包 $59 | **类型**: 开源 Product Hunt 替代品

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交 | https://open-launch.com/ → Submit 按钮 | Dofollow（Top 3 + 展示徽章） | 中 |
| Premium 发布 | https://open-launch.com/pricing | Dofollow（保证） | 高 |
| SEO Growth Package | https://open-launch.com/pricing | Dofollow + 定制文章 | 高 |

### 操作步骤

1. 访问 https://open-launch.com/
2. 注册账号并完善个人资料
3. 点击「Submit」进入提交表单
4. 填写以下信息：
   - **Product Name**：产品名称
   ...
   - **Description**：详细介绍
   - **Website URL**：产品网址
   - **Logo & Screenshots**：视觉素材
5. 选择发布方案：
   - **Free ($0)**：排队发布，每天 8:00 AM UTC 上线，dofollow 链接需排名 Top 3 且展示徽章
   - **Premium ($12/次)**：次日发布，无需排队，**保证获得高权重 dofollow 外链**，每天限 10 个名额
   - **SEO Growth ($59/次)**：包含 Premium 所有功能 + 定制 SEO 文章（针对「[产品名] review」关键词优化），5-7 天交付
6. 提交后等待发布

### Tips

- 免费版当前等待约 33 周，建议直接选 $12 Premium 跳过排队
- SEO Growth Package 原价 $199 现促销 $59，包含人工撰写的产品评测文章
- 开源项目（GitHub: openlaunch-org/Open-Launch），透明度高
- 每天仅展示固定数量的产品，确保每个产品有足够曝光
- 月访问量约 15，流量极低但外链价值在 DR65

---

## 6. LaunchIgniter (launchigniter.com)

**DA/DR**: DA14 / DR74 | **费用**: 免费（Premium 可选） | **类型**: 每周发布平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交产品 | https://launchigniter.com/ → 顶部「Submit」按钮 | Nofollow | 低 |

### 操作步骤

1. 访问 https://launchigniter.com/
2. 注册账号并完善个人资料
3. 点击顶部「Submit」按钮
4. 填写产品详情表单：
   - **Product Name**：产品名称
...
- **链接为 Nofollow**，SEO 直接价值有限，但有品牌曝光作用
- 支持从 Product Hunt 或 Peerlist **导入已有 listing**，省去重复填写
- 每周仅展示固定数量产品，结构化发布
- 有 Premium 计划（付费置顶 + 徽章），具体价格需在站内查看
- 月访问量极低（约 2），当前更多是占位价值
- DR74 虽高但 nofollow 链接不传递权重，优先级可降低

---

## 7. Peerlist (peerlist.io)

**DA/DR**: DA ~30 / DR76 | **费用**: 免费 | **类型**: 开发者/设计师专业社区

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 创建个人资料 + 项目 | https://peerlist.io/ → 注册 | Dofollow（个人资料页） | 高 |
| Project Spotlight 发布 | https://peerlist.io/projects → Launch Project | Dofollow | 高 |

### 操作步骤

1. 访问 https://peerlist.io/ 注册账号
2. **完善个人资料**：填写职业信息、技能、社交链接（个人资料页自带 dofollow 链接）
3. **获得 Verified Profile**：完成验证流程（发布项目的前提条件）
4. 进入 https://peerlist.io/projects，点击周 Spotlight 横幅中的「Launch Project」
5. 从弹窗中选择已创建的项目，点击「Launch Project」
6. 确保项目信息完整：
   - **Name**：简短好记，1-2 个词
   - **Logo**：确保 64x64 像素下清晰
   - **Tagline**：4-6 个词说清产品功能
   - **Description**：详细描述，可用故事化表达
   - **Screenshots**：用满所有截图位
   - **Demo Video**（推荐）：产品演示视频
   - **Website URL**：产品网址
7. 发布后积极参与社区互动

### Tips

- **发布窗口：每周一，UTC 00:00 - 23:59**，必须在此时间段内发布
- 必须有 **Verified Profile** 才能发布项目
- 仅 **100% 完成**的项目才有资格发布到 Launchpad
- DR76 + Dofollow，在免费平台中属于最高级别 SEO 价值
- 类似 LinkedIn 但更聚焦技术圈，适合做个人品牌建设
- 即时审批，发布后立即生效
- 月访问量约 120K，流量可观
- 发布后不要消失——积极评论其他人的项目，互相支持

---

## 8. TopStartups.io (topstartups.io)

**DA/DR**: 未公开确切数据 | **费用**: 免费 | **类型**: 创业公司目录（投资人关注）

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| Airtable 表单提交 | https://airtable.com/shrxE33nk4Qfzx2K9 | 待确认 | 中 |

### 操作步骤

1. 访问 https://topstartups.io/
2. 点击导航栏中的「Add Startup」按钮
3. 系统跳转到 Airtable 表单：https://airtable.com/shrxE33nk4Qfzx2K9
4. 在 Airtable 表单中填写以下信息：
   - **Startup Name**：公司名称
   - **Website URL**：公司网址
   - **Description**：公司简介
   - **Category/Industry**：所属行业
   - **Funding Info**：融资信息（如有）
   - **Investors**：投资人（如有）
   - **Logo**：公司 logo
5. 提交后等待审核，通过后出现在目录中
...
- 该平台主要展示获得 Sequoia、A16Z、YC 等顶级 VC 投资的创业公司
- 如果你有知名投资人背景，被收录的概率更高
- 免费提交，无付费选项
- 链接属性（dofollow/nofollow）需提交后确认
- 对获取投资人关注有间接价值
- 提交表单为 Airtable，填写简单快速

---

## 9. Index.co (index.co)

**DA/DR**: 高权重域名 | **费用**: 免费（Premium $25） | **类型**: 创业公司-投资人对接平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 创建公司资料 | https://index.co/startup | Dofollow | 中 |

### 操作步骤

1. 访问 https://index.co/startup
2. 点击「Join」或「Sign Up」注册账号（免费）
3. 创建公司 Profile，填写：
   - **Company Name**：公司名称
   - **Website**：公司网址
   - **Description**：公司简介
   ...
   - **Logo**：公司 logo
4. 完善资料后提交，基础版免费
5. 可选升级 Premium ($25) 获得更多曝光和功能

### Tips

- 由 The Next Web 联合创始人 Patrick de Laive 创建
- 被 500+ 顶级投资人和 VC 基金使用来发现项目
- Index 会自动匹配合适的投资人（投资规模、阶段、地区）
- 主要价值不在 SEO 外链，而在**投资人对接**
- 免费版即可创建完整公司 Profile
- $25 Premium 提供增强曝光和优先匹配

---

## 10. Crozdesk (crozdesk.com)

**DA/DR**: DA44 | **费用**: 免费 | **类型**: B2B 软件比较平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 认领/创建软件 listing | https://crozdesk.com/claims/new | Dofollow | 高 |
| 新建软件 listing | https://vendor.revleads.com/user/signup | Dofollow | 高 |

### 操作步骤

#### 方法一：认领已有 Listing

1. 访问 https://crozdesk.com/claims/new
2. 搜索你的软件名称（搜索框下拉列表）
3. 填写认领表单：
   - **First Name** / **Last Name**：你的姓名
   - **Company Name**：公司名称
   - **Your Position**：职位
   - **Email**：**必须使用公司域名邮箱**（与软件 listing 中的域名一致）
   - **Phone Number**：电话
   - **Country**：国家
4. 提交后 Crozdesk 验证身份后分配管理权

#### 方法二：创建新 Listing

1. 如果在 claims/new 搜索不到你的软件
2. 访问 https://vendor.revleads.com/user/signup 注册供应商账号
3. 按引导创建新的软件 listing
4. 填写软件详细信息、分类、功能描述等
5. 提交后等待审核
...
- **必须使用公司域名邮箱**认领，Gmail/Hotmail 等可能被拒
- 所有被列入的软件自动参与 Crozdesk 年度 Software Awards
- 有机会被收录进 Buyer Guide 报告和 Market Radar
- DA44 + Dofollow，SEO 价值不错
- 完全免费，无隐藏费用
- 合作网络月曝光量超 1 亿次
- 适合 B2B SaaS 产品
...
**DA/DR**: DA91 / DR90 | **费用**: 免费 | **类型**: 全球最大商业信息数据库

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 创建公司 Profile | https://www.crunchbase.com/ → Resources → Create Profile | Dofollow | 极高 |

### 操作步骤

1. 访问 https://www.crunchbase.com/，点击右上角「Log In」
2. 选择「Register」注册账号（可用 Google 或 LinkedIn 社交登录）
3. **完成社交认证**：进入 Account Settings → Social Authentication → 连接社交账号
4. 搜索确认你的公司尚未在 Crunchbase 中存在
5. 点击顶部导航「Resources」→「Create Profile」
6. 选择 Profile 类型：**Company**
7. 填写以下信息：
   - **Company Name**：公司名称
   - **Company Logo**：logo 图片
   - **Short Description**：简短描述
   - **Long Description**：详细描述
   - **Website URL**：公司网址（**dofollow 外链，DA91 权重极高**）
   - **Social Media Links**：社交媒体链接
   - **Founded Date**：成立日期
   - **Headquarters**：总部地址
   - **Industries**：所属行业（推荐选 3-5 个）
   - **Number of Employees**：员工人数
   - **Founders**：创始人信息
   - **Funding Rounds**：融资轮次（如有）
8. 点击右上角「Save All Edits」保存
9. Profile 立即生效并可被搜索到

### Tips

- **DA91 / DR90 + Dofollow = 最高级别的免费外链之一**
- 必须完成社交认证（Google/LinkedIn），否则无法创建 Profile
- 创建前务必搜索确认公司不存在，避免重复
- 投资人、记者、合作伙伴经常通过 Crunchbase 发现公司
- Profile 越完整（融资、团队、新闻），曝光越多
- 完全免费，无需付费即可创建和管理
- 建议同时创建公司 Profile 和个人 Profile（双重外链）
- Board Members、Advisors 信息也可添加

---

## 12. SaaS Mag (saasmag.com)

**DA/DR**: DA ~40 | **费用**: 免费 | **类型**: SaaS 行业媒体（Guest Post）

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| Guest Post 投稿 | https://www.saasmag.com/contributions/ | Dofollow（文内链接） | 高 |

### 操作步骤

1. 访问 https://www.saasmag.com/contributions/ 了解投稿要求
2. 阅读详细指南：https://www.saasmag.com/submission-guidelines/
3. 准备文章，需满足以下要求：
   - **字数**：至少 1,000 词，推荐长文不超过 6,000 词
   - **语言**：美式英语，遵循 AP Style
   - **内容方向**：SaaS 增长策略、行业趋势、创新案例
   - **链接**：鼓励引用权威来源；可包含自己网站/产品链接，但**不能过度推广**
   - **原创性**：不接受抄袭内容；个人博客已发布的文章可能被接受（编辑酌情决定）
4. 仔细校对拼写和语法（错误过多会被退稿）
5. 通过投稿页面提交文章
6. 等待编辑审核和反馈

### Tips

- 发布后 SaaS Mag 会在 Facebook、LinkedIn、Twitter、Instagram **全渠道推广**
- 文章会被收录进**每周 newsletter**（10,000+ 订阅者）
- 签署 Contributor Agreement，授予 SaaS Mag 非独占全球发布权
- **不接受纯广告或付费推广内容**
- 适合写行业洞察类文章，自然植入产品链接
- 文章质量要求高，投入产出比优于普通目录提交
- 建议先研究已发布文章的风格再投稿

---

## 13. There's An AI For That (theresanaiforthat.com)

**DA/DR**: DR80+ | **费用**: $347 一次性 | **类型**: 全球最大 AI 工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 付费提交 AI 工具 | https://theresanaiforthat.com/get-featured/ | Dofollow | 极高 |

### 操作步骤

1. 访问 https://theresanaiforthat.com/get-featured/
2. 支付 **$347 一次性费用**
3. 付款完成后跳转到在线表单，填写：
   - **Tool Name**：AI 工具名称
   - **Tool URL**：工具网址
   ...
   - **Category**：所属分类
   - **Featured Image**：特色图片
4. 提交后等待人工审核（平均 1-2 天）
5. 审核通过后收到邮件通知，工具上线
6. 如未通过审核，**自动全额退款**

### Tips

- **#1 AI 工具目录**，DR80+ 的 dofollow 链接价值极高
- Newsletter 有 **2.1M+ 订阅者**，提交后自动获得 newsletter 推荐（价值 $1,000）
- 如果在 TAAFT **首发**（先于其他平台发布），额外赠送 **$300 PPC 广告积分**
- 接受 AI 工具、GPTs 和 AI 影响者（非人类角色）
- listing 永不过期，持续获得流量
- 提交后**无法更改 URL**，如换域名需用 301 重定向
- 预估点击量 700 - 10,000+
- 虽然价格不低，但考虑到 DR80+ dofollow + newsletter 曝光，ROI 很高

---

## 14. Futurepedia (futurepedia.io)

**DA/DR**: DR70+ | **费用**: $247 / $497 | **类型**: AI 工具评测目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| Verified Listing | https://www.futurepedia.io/submit-tool | Dofollow | 高 |
| Verified + 1000 Clicks | https://www.futurepedia.io/enhanced | Dofollow + Newsletter | 极高 |

### 操作步骤

1. 访问 https://www.futurepedia.io/submit-tool 或 https://futurepedia.gumroad.com/l/submit-tool
2. 选择方案：
   - **Verified Listing ($247)**：7 天内发布，含 verified 标志、视频展示位、教程位
   - **Verified + 1000 Clicks ($497)**：2 个工作日内发布，含以上所有 + Newsletter 推荐（250K+ 订阅者，价值 $399）+ Verified 标志（价值 $250）
3. 购买后在结账时填写 **Tool URL**
4. Futurepedia 团队负责完善其余信息
5. 审核通过后上线，不通过则**全额退款**
6. 如遇问题联系 contact@futurepedia.io

### Tips

- **仅接受 AI 工具**，非 AI 产品、newsletter、其他目录会被拒
- **不接受 NSFW 内容**
- $247 方案可能会售罄（sold out），建议关注补货
- $497 方案额外包含 newsletter 特刊（覆盖 250K+ AI 从业者）
- 还有 Enterprise Package（定制价格），包含专属客户经理、赞助、联合品牌活动
- 月访问量 400K+，流量可观
- 所有 listing 经编辑审核，可能被拒绝或下架

---

## 15. ToolPilot (toolpilot.ai)

**DA/DR**: DA26 / DR77 | **费用**: 免费（需回链） | **类型**: AI 工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交 AI 工具（需回链） | https://www.toolpilot.ai/pages/submit-your-ai-tool | Dofollow | 高 |

### 操作步骤

1. 访问 https://www.toolpilot.ai/pages/submit-your-ai-tool
2. 在你的网站上**先添加 ToolPilot 的回链**：
   - 从 ToolPilot 品牌指南页面下载徽章/logo
   - 将徽章放置在你网站的显眼位置（Footer 或 Partners 区域）
   - 链接指向 https://www.toolpilot.ai/
3. 填写提交表单：
   - **Tool Name**：AI 工具名称
   - **Tool URL**：工具网址
   - **Description**：工具描述
   - **Category**：所属分类
   - **Screenshots**：产品截图
4. 在表单中填入回链所在页面的 URL，或发邮件到 contact@toolpilot.ai 确认
5. 提交后等待审核

### Tips

- **免费提交的前提是必须在你的网站上放置 ToolPilot 回链**
- 回链要求是强制性的（mandatory for all free listings）
- DR77 + Dofollow，SEO 价值很高
- 月访问量约 7K
- 审核时间不固定，可能数小时到数周
- 添加回链后可发邮件通知 ToolPilot 以加速审核
- 按类别组织（生产力、营销、设计、音频、视频编辑等）

---

## 16. AI Tools Directory (aitoolsdirectory.com)

**DA/DR**: 中等权重 | **费用**: 免费 | **类型**: AI 工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交 AI 工具 | https://aitoolsdirectory.com/submit-tool | Dofollow | 中 |

### 操作步骤

1. 访问 https://aitoolsdirectory.com/submit-tool
2. 填写提交表单：
   - **Tool Name**：AI 工具名称
   - **Website URL**：工具网址
   - **Description**：工具描述
   - **Category**：所属分类
   - **Pricing Info**：定价信息和方案
   - **Screenshots**：3-5 张清晰截图
   - **Social Proof**（推荐）：用户评价、客户 logo、用户数等
   - **CTA**：主要行动号召（如「Try Free」「Watch Demo」）
3. 可选附加 30 秒产品 Demo 视频
4. 提交后等待审核，通过后自动上线
5. 如有问题联系 hello@aitoolsdirectory.com

### Tips

- 完全免费，不收取任何费用
- 有 Featured Tools Premium Placement 可选（付费置顶，价格需联系获取）
- 建议准备充分的社会证明材料（用户数、评价引用等）
- 推荐 7 天发布策略：Day 1-2 提交 + 准备素材，Day 3 发博客，Day 4 LinkedIn/Reddit 分享，Day 5 邮件通知，Day 6 提交其他目录，Day 7 收集反馈
- 浏览和发现工具完全免费

---

## 17. TopAI.tools (topai.tools)

**DA/DR**: 中高权重 | **费用**: 免费 / Pro $39 / Featured $229 | **类型**: AI 工具聚合搜索引擎

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交 | https://topai.tools/submit | Dofollow | 中 |
| Pro 提交 | https://topai.tools/submit | Dofollow（高亮） | 高 |
| Featured 提交 | https://topai.tools/submit | Dofollow（置顶） | 极高 |

### 操作步骤

1. 访问 https://topai.tools/submit
2. 选择提交方案：
   - **Free**：基础目录 listing，48 小时审核周期
   - **One-Time Pro ($39)**：高亮卡片展示 + 终身 listing + 即时审核
   - **Featured Listing ($229)**：精选区域置顶 + 高亮卡片 + 即时审核
3. 填写提交表单：
   - **Tool Name**：工具名称
   - **Tool URL**：工具网址
   - **Description**：工具描述
   ...
   - **Features**：核心功能列表
   - **Screenshots**：产品截图
4. 免费方案等待 48 小时审核；付费方案即时审核
5. 审核通过后上线

### Tips

- 免费方案已经提供 dofollow 外链，预算有限可先用免费
- $39 Pro 方案终身有效 + 高亮展示，性价比较高
- $229 Featured 适合需要最大曝光的产品
- 还可创建 Premium Listing Profile 来认证产品功能、定价、使用场景
- 列出数千个 AI 工具，是最大的 AI 工具聚合器之一
- 每天有大量用户浏览发现新工具

---

## 18. AI Directory (aidirectory.org)

**DA/DR**: 中等权重 | **费用**: 免费 | **类型**: AI/ML 公司综合目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交 AI 公司 | https://www.aidirectory.org/user-submit/ | Dofollow | 中 |

### 操作步骤

1. 访问 https://www.aidirectory.org/user-submit/
2. 填写提交表单（标 * 为必填）：
   - **Post Title** *：公司/工具名称
   - **Category** *：从 50+ 分类中选择，包括：
     - Advertising, Agentic AI, AI Agents, AI as a Service
     - Computer Vision, Deep Learning, Machine Learning
     - Chatbots, NLP, Speech Recognition
     - Healthcare, Finance & Insurance, Cybersecurity
     - Gaming AI, Robotics, Virtual Personal Assistants 等
   - **Company Name** *：公司名称
   - **Website Address** *：网址（外链所在）
   - **Phone Number** *：联系电话
   - **Email** *：联系邮箱
   - Street / City / State / Zip Code / Country（选填）
   - **Description**（选填但强烈建议填写）：公司/工具描述
3. 完成 reCAPTCHA 验证
4. 提交后等待审核

### Tips

- 自称"全球最全面的 AI/ML 公司在线目录"
- 完全免费提交
- 分类覆盖 50+ 个 AI 细分领域，选择最精准的分类
- 电话号码为必填字段，注意准备
- Description 虽然选填但强烈建议写详细，影响审核通过率
- 使用 WordPress WP User Frontend 插件管理表单

---

## 19. The Rundown AI (rundown.ai)

**DA/DR**: 高权重（Newsletter 流量巨大） | **费用**: 免费 | **类型**: AI Newsletter + 工具推荐

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 推荐工具（免费） | https://www.rundown.ai/submit | Nofollow（网站）/ 高流量（Newsletter） | 中（SEO）/ 极高（流量） |
| Newsletter 付费推荐 | 通过 Typeform 申请 | Newsletter 内链接 | 极高（流量） |

### 操作步骤

1. 访问 https://www.rundown.ai/submit
2. 页面有两个通道：
   - **Recommend A Tool**：免费推荐，填写 Tally 嵌入表单
   - **Newsletter Feature**：付费推荐，点击「Learn More」跳转 Typeform
3. 填写推荐表单（Tally 表单）：
   - **Tool Name**：工具名称
   - **Tool URL**：工具网址
   - **Description**：工具描述和特点
   - **Why Recommend**：为什么推荐这个工具
4. 提交后等待 The Rundown 团队审核
5. 如被选中，工具将出现在 The Rundown Newsletter 中

### Tips

- **The Rundown Newsletter 有 1,000,000+ 订阅者（官方称 2.1M+）**
- 被 Newsletter 推荐的流量价值远超普通目录外链
- 免费推荐通道无保证被选中，但完全免费
- Newsletter 付费推荐是另一个通道，具体价格需通过 Typeform 询价
- 网站本身的 SEO 外链价值一般，核心价值在**Newsletter 流量**
- 每天早上发送 AI 新闻摘要，读者群体精准（AI 从业者和爱好者）
- 100% 免费提交工具推荐

---

## 20. KillerStartups (killerstartups.com)

**DA/DR**: DA55-56 / DR73 | **费用**: 免费提交 / 付费发布 ~$1,500 | **类型**: 创业公司评测媒体

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交创业公司 | https://killerstartups.com/submit-startup/ | Nofollow | 中（品牌曝光） |
| 付费 Feature Article | 联系编辑团队 | Nofollow | 中（品牌曝光） |

### 操作步骤

1. 访问 https://killerstartups.com/
2. 点击首页「Submit Your Startup」按钮，或直接访问 https://killerstartups.com/submit-startup/
3. 也可先查看提交指南：https://killerstartups.com/how-to-submit/
4. 在提交表单中填写（**所有字段必填**）：
   - **Startup Name**：公司名称
   - **Website**：公司网址
   - **Problem You Solve**：解决什么问题
   - **Founders**：创始人信息
   - **Startup Inspiration**：创业灵感/动机
   - **Product Description**：产品详细描述
   - 其他要求的补充信息
5. 提交后等待编辑团队审核
6. 编辑团队根据你的信息**撰写 Feature Article**
7. 文章每周一发布（节假日顺延到周二）

### Tips

- **所有表单字段必须认真填写**，留空或填占位符/复制粘贴内容会被直接拒绝
- 编辑团队会基于你的回答**创作原创文章**，不是简单 listing
- 发布后文章出现在首页 Featured 区域 + Newsletter（数千创始人订阅）
- 链接为 **Nofollow**，直接 SEO 价值有限
- DA55 / DR73，品牌曝光价值不错
- 月访问量 125,000+ 独立访客，年总访问量 600 万+
- 付费发布约 $1,500（含内容策划、撰写、发布全套服务）
- 社区投票功能可增加互动
- 发布后可将文章用于 PR、社交媒体、邮件签名等二次传播
...
### 第一梯队：高价值免费（立即执行）
1. **Crunchbase** — DA91/DR90 Dofollow，免费，最高优先级
2. **Peerlist** — DR76 Dofollow，免费，即时审批
3. **DevHunt** — DR62 Dofollow，免费，开发者工具必做
4. **TinyLaunch** — DR71 Dofollow，免费
5. **Crozdesk** — DA44 Dofollow，免费，B2B SaaS 适用

### 第二梯队：低成本高回报
6. **Open Launch Premium** — DR65 Dofollow，$12/次
7. **MicroLaunch** — DR58 Dofollow，免费或 $39
8. **TopAI.tools Free** — 免费 Dofollow
9. **OpenHunts** — DR50 Dofollow，免费
10. **ToolPilot** — DR77 Dofollow，免费但需回链

### 第三梯队：付费高权重
11. **There's An AI For That** — DR80+ Dofollow，$347（AI 工具必投）
12. **Futurepedia** — DR70+ Dofollow，$247-$497
13. **TopAI.tools Pro** — $39 高亮展示

### 第四梯队：品牌曝光（非 SEO 重点）
14. **The Rundown AI** — 免费，核心价值在 Newsletter 流量
15. **SaaS Mag** — Guest Post，需投入写作精力
16. **KillerStartups** — Nofollow，$1,500 付费或免费提交
17. **LaunchIgniter** — DR74 但 Nofollow
18. **Index.co** — 投资人对接价值
19. **TopStartups.io** — Airtable 表单，快速占位
20. **AI Directory** — 免费，AI/ML 公司目录

---

*注：DA = Moz Domain Authority, DR = Ahrefs Domain Rating。数据可能随时间变化，建议定期用 Ahrefs/Moz 工具验证。*


---

# 新增网站详细操作指南（第二批：Software/AI/Podcast/Wiki/PR 类）

# SEO 外链操作指南 — 第二批（Software/AI/Podcast/Wiki/PR/Startup 类）

> 生成日期：2026-03-25
> 共 20 个网站（GetListed.ai 已跳过）

---

## 1. Alternative.me (alternative.me)

**DA/DR**: DR73 | **费用**: 免费 | **类型**: 软件替代品比较目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交软件产品 | https://alternative.me/how-to/submit-software/ | Dofollow | 高 |
| 用户Profile | https://alternative.me/signup/ | Dofollow | 中 |

### 操作步骤

1. 访问 https://alternative.me/signup/ 注册账号（邮箱注册）
2. 验证邮箱，登录账号
3. 进入个人 Dashboard，找到红色的 **"Submit Software"** 按钮
4. 填写提交表单：
   - **软件名称**（必填）
   - **软件官网 URL**（必填，这就是你的外链来源）
   - **简短描述**
   - **分类标签**
   - **Logo / 截图**
5. 提交后等待审核（通常 24-72 小时）
6. 审核通过后，软件页面上会显示 Dofollow 链接指向你的官网

### Tips

- Alternative.me 月访问量约 130 万，主要流量来自美国、德国、印度
- 产品页面在 Google 搜索 "[竞品名] alternative" 时往往排名首页，额外引流价值大
- 建议把你的产品定位为某个知名软件的替代品，这样更容易被搜索到
- 提交时描述要详细、专业，附上高质量截图可提升审核通过率
- 可以在产品页面回复评论，增加互动提升排名

---

## 2. SiteLike.org (sitelike.org)

**DA/DR**: DR71 | **费用**: 免费 | **类型**: 相似网站查找引擎

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交网站 | https://www.sitelike.org/new-site | Dofollow | 高 |
| 搜索并触发收录 | https://www.sitelike.org/ 首页搜索栏 | Dofollow | 高 |

### 操作步骤

1. 访问 https://www.sitelike.org/ 首页
2. 在搜索栏输入你的网站域名，点击搜索
3. 如果网站未被收录，系统会提示可以手动提交，或直接访问 https://www.sitelike.org/new-site
4. 在 "Add new website" 页面填写：
   - **网站 URL**（必填）
   - **网站名称**
   - **网站描述**
   - **分类选择**
5. 点击 **"Check First"** 按钮验证 URL
6. 验证通过后点击 **"Submit"** 提交
7. 提交处理约 1-2 分钟，列表页 **即时上线**

### Tips

- SiteLike 提供免费的 Dofollow 外链，整个过程 5 分钟内完成
- 每个提交的网站会获得独立的公开列表页，页面内含指向你域名的 Dofollow 链接
- 无需注册账号即可提交
- 如果首页搜索找到你的网站，说明已被自动收录，无需再次提交
- 可为多个网站分别提交，每个都获得独立外链

---

## 3. AITools.inc (aitools.inc)

**DA/DR**: DR67 | **费用**: 免费/$129 | **类型**: AI工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交 (Free Listing) | https://aitools.inc/submit | Nofollow（推测） | 中 |
| 付费快速通道 (Fast Lane) | https://aitools.inc/submit | 可能 Dofollow | 高 |

### 操作步骤

1. 访问 https://aitools.inc/submit
2. 选择提交方式：
   - **Free Listing**（$0）：进入排队，30-90 天上线，不保证收录
   - **Fast Lane**（$129 一次性）：24-48 小时上线，保证收录
3. 点击 "Submit Now" 进入 Typeform 表单
4. 填写：
   - **AI 工具名称**（必填）
   - **工具 URL**（必填）
   - **功能描述**
...
- 免费提交等待时间很长（最多90天），且不保证收录
- 如果预算允许，$129 的 Fast Lane 性价比不错
- 每天有大量 AI 从业者在此搜索工具，引流效果好
- 表单通过 Typeform 托管，填写体验流畅
- 提交后不需要放反向链接到自己网站

---

## 4. FutureTools (futuretools.io)

**DA/DR**: DR64 | **费用**: 免费 | **类型**: AI工具数据库

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交AI工具 | https://futuretools.io/submit-a-tool | Dofollow（列表页链接） | 高 |

### 操作步骤

1. 访问 https://futuretools.io/submit-a-tool
2. 填写提交表单（全部标 * 为必填）：
   - **Tool Name**（工具名称）*
   - **Tool URL**（工具网址）*
   - **Short Description**（简短描述）*
   - **Category**（分类）*：可选 Chat、Generative Art、Generative Video、Generative Code、Text-To-Speech、Search Engines、Productivity、Marketing、Design、Writing、Music、Research、Education、Finance、Healthcare、Legal、Sales、Customer Support、Other
   - **Pricing**（定价模式）*：Free / Freemium / Paid / Open Source
   - **Your Email**（你的邮箱）*
   - **Your Name**（你的名字）
3. 可选：勾选订阅 Future Tools Newsletter
4. 完成 CAPTCHA 验证
5. 提交后由创始人 Matt 人工审核
...
- 完全免费，无付费通道
- 由知名 AI 博主 Matt Wolfe 运营，社区影响力大
- 审核较严格，会过滤掉低质量项目、垃圾信息、山寨产品和成人内容
- 产品必须是可用的、有真实价值的 AI 工具
- 描述要突出工具的独特价值，避免泛泛而谈
- 通过审核后会获得独立的工具页面，包含指向你网站的链接

---

## 5. ToolsFine (toolsfine.com)

**DA/DR**: DR57 | **费用**: 免费/$100+ | **类型**: AI工具精选目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交工具 | https://tally.so/r/wvB7Xg | Dofollow（推测） | 中 |
| 付费推荐位 | https://tally.so/r/nPAvpB | Dofollow | 高 |
| 友情链接交换 | https://toolsfine.com/links | Dofollow | 中 |

### 操作步骤

**免费提交（Starter Plan）：**

1. 访问 https://tally.so/r/wvB7Xg（免费提交表单）
2. 填写工具信息：名称、URL、描述、分类
3. 提交后等待审核（正常处理时间约 72 小时）
4. 审核通过后永久保留链接

**加速处理方法：**

- 在你的网站首页或页脚添加一个指向 https://toolsfine.com/ 的 Dofollow 链接
- ToolsFine 会优先免费处理你的提交

**付费选项：**

| 方案 | 费用 | 内容 |
|------|------|------|
| Featured Promotion | $100/年 | 首页和列表页顶部展示位 |
| Update Service | $50/年/页 | 产品信息更新服务 |
| Insert Link | $100/年 | 文章内插入推广链接 |
| Guest Post | $100/年 | 付费发布推广文章 |

### Tips

- 仅接受 AI、科技、经济、能源、软硬件相关内容
- 禁止赌博、色情、暴力、毒品等内容
- 不接受二次跳转或联盟营销链接
- 付费后 7 天内需完成付款，否则内容被移除
- 联系邮箱：partner@toolsfine.com
- 如果能提供反向链接给 ToolsFine，可以免费加速审核

---

## 6. Ben's Bites (news.bensbites.com / catalog.bensbites.com)

**DA/DR**: DR53 | **费用**: 免费 | **类型**: AI Newsletter + 工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交新闻帖子 | https://news.bensbites.com（登录后提交） | Nofollow | 中 |
| 提交工具到 Catalog | https://catalog.bensbites.com/tools | Nofollow（推测） | 中 |

### 操作步骤

**方式一：提交新闻帖子**

1. 访问 https://news.bensbites.com/login 注册/登录
2. 创建账号后在首页找到提交入口
3. 发布包含你工具/产品链接的帖子
4. 社区投票，高票帖子会被收入每日 Newsletter

**方式二：提交工具到 Catalog**

1. 访问 https://catalog.bensbites.com/
2. 浏览工具目录，查看是否已收录
3. 如未收录，可通过 catalog 的提交入口添加工具
4. 填写工具名称、URL、描述、分类等信息
5. 审核通过后获得工具展示页面

### Tips

- Ben's Bites 是 AI 领域最知名的 Newsletter 之一，由 Ben Tossell 运营
- 如果帖子被选入每日 Newsletter，曝光量极大（数十万订阅者）
- 新闻帖子采用社区投票机制，高质量内容更容易脱颖而出
- catalog.bensbites.com 提供工具教程和展示，更偏向内容驱动
- Pro 会员 $150（限时，原价 $250），可获得更多功能
- 虽然链接可能是 Nofollow，但品牌曝光和流量价值很高

---

## 7. BAI.tools (bai.tools)

**DA/DR**: DR48 | **费用**: 免费/$19.9/$29.9 | **类型**: AI工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 免费提交 | https://bai.tools/submit-ai-tools | Nofollow（免费版） | 低 |
| Standard Listing | https://bai.tools/submit-ai-tools | Dofollow | 中 |
| Pro Listing | https://bai.tools/submit-ai-tools | Dofollow | 高 |

### 操作步骤

1. 访问 https://bai.tools/submit-ai-tools
2. 填写表单：
   - **AI Tool Name**（工具名称，必填）
   - **Website URL**（网站地址，必填）
3. 选择套餐：

| 套餐 | 价格 | 上线时间 | 首页推荐 | 分类置顶 | Dofollow |
|------|------|----------|----------|----------|----------|
| FREE | $0 | 1-6 个月 | 无 | 无 | 无 |
| STANDARD | $19.9 | 24 小时内 | 7 天 | 7 天 | 有 |
| PRO（推荐） | $29.9 | 24 小时内 | 30 天 | 30 天 | 有 |

4. 免费版直接提交，付费版选择套餐并完成支付
5. 所有套餐均为终身列表（Lifetime listing）

### Tips

- 免费版等待时间很长（最久 6 个月），且没有 Dofollow 链接
- $19.9 的 Standard 套餐性价比不错，24 小时上线 + Dofollow
- Pro 套餐 $29.9 多了 23 天的推荐期，差价不大建议直接选 Pro
- 由于提交量大，免费版审核时间不确定
- 表单非常简单，只需填工具名和 URL

---

## 8. TwelveTools (twelve.tools)

**DA/DR**: DR80 | **费用**: 免费（需互链） | **类型**: 生产力工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交工具 | https://twelve.tools/submit-your-tool | Dofollow | 高 |

### 操作步骤

1. 访问 https://twelve.tools/submit-your-tool
2. 填写提交表单：
   - **工具名称**（必填）
   - **工具 URL**（必填）
   - **描述**
   - **分类选择**（从预设列表中选择一个）
   - **Logo**（正方形，最小 128px × 128px）
3. **重要**：勾选确认"我已在网站首页或页脚添加了指向 https://twelve.tools 的链接/徽章"
4. 从页面提供的徽章样式（白色/浅色/深色）中选择一个，复制嵌入代码添加到你的网站
5. 提交后进入排队等待审核

### Tips

- DR80，是本批次中域名权重最高的目录之一，SEO 价值很高
- **必须在网站上放置反向链接/徽章**，否则不会发布
- twelve.tools 会定期自动检查你网站上的反向链接是否仍然存在
- 每天最多发布 12 个新工具（每 2 小时一个），当前排队约 269 个工具
- 这意味着排队时间可能长达 3-4 周
- 面向创业者、自由职业者和小企业主
- 审核标准注重工具的真实实用价值，拒绝营销炒作

---

## 9. ToolsDirectoryOnline (toolsdirectoryonline.com)

**DA/DR**: 未标注 | **费用**: 免费 | **类型**: SaaS/AI工具目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交工具 | https://toolsdirectoryonline.com/submit | Dofollow（推测） | 中 |

### 操作步骤

1. 访问 https://toolsdirectoryonline.com/submit
2. 填写提交表单：
   - **Website URL**（必填，系统会自动格式化域名）
   - Short Description（可选，240 字符限制）
   - Category（可选，30+ 分类可选，系统可自动检测）
   - Pricing Model（可选）：Free / Freemium / Paid / Open Source
3. 无需注册账号
4. 点击提交
...
- **初审**：24-48 小时
- **深度分析**：一周内（通过初审后）
- **发布**：审核通过后立即上线，可按分类和关键词搜索

### Tips

- 完全免费，无付费选项
- 不需要注册账号，提交门槛极低
- 接受 SaaS 产品、AI 工具、开发者软件和生产力应用
- 工具必须功能正常且提供真实价值
- 如需后续更新列表信息，可联系客服
- 提交只需 URL，其余信息系统自动抓取，非常便捷

---

## 10. 10015.io (10015.io)

**DA/DR**: DR50 | **费用**: 免费 | **类型**: 在线工具箱 + 产品目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交到 Product Finder | https://10015.io/product-finder/submit | Dofollow（推测） | 中 |

### 操作步骤

1. 访问 https://10015.io/product-finder/submit
2. 输入你的产品网页 URL（必填）
3. 系统自动抓取网站数据并预填提交表单
4. 检查并修改自动填充的字段（名称、描述、分类等）
5. 确认无误后提交

### Tips

- 完全免费
- Product Finder 是 10015.io 较新的功能模块，正在积极扩充产品库
- 只需输入 URL，系统自动抓取信息，提交过程极其简单
- 10015.io 本身是一个流行的在线工具集合网站（一站式工具箱）
- 适合提交 SaaS 产品、AI 工具、应用程序和浏览器插件
- 由于是新功能，竞争较少，收录概率较高

---

## 11. Apple Podcasts (podcasts.apple.com)

**DA/DR**: DA100 | **费用**: 免费 | **类型**: 播客目录（全球最大）

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交播客 RSS Feed | https://podcastsconnect.apple.com | Nofollow | 高（品牌+流量） |

### 操作步骤

1. **准备工作**：
   - 需要一个 Apple ID（启用双重认证）
   - 需要一个有效的播客 RSS Feed（至少包含一集已发布的节目）
   - 在 RSS Feed 中设置好播客名称、描述、封面图（1400×1400 至 3000×3000 px）
2. 访问 https://podcastsconnect.apple.com 登录 Apple ID
3. 首次登录需创建 Apple Podcasts Connect 账户：
   - 选择账户类型：个人（Individual）或公司（Company）
   - 填写联系信息
   - 同意服务条款
4. 点击左上角 **"+"** 按钮，选择 **"New Show"**
5. 选择 **"Add existing show (RSS Feed)"**
6. 粘贴你的 RSS Feed URL
7. 检查节目信息页面，确保所有内容正确
8. 设置 **Content Rights**（确认拥有内容版权）
9. 填写 **Show Contact**（节目联系方式）
10. 在 **Availability** 中选择上线的国家/地区
11. 点击右上角 **"Submit For Review"**
12. 等待审核（通常 24 小时至 2 周）

### Tips

- Apple Podcasts 是全球最大的播客目录，DA100
- 链接虽是 Nofollow，但品牌曝光和引流价值极高
- 审核通过后，Apple 每 24 小时自动检查你的 RSS Feed 更新
- 播客描述中可以包含你的网站链接
- 在播客的 show notes（节目笔记）中可以放网站链接，虽然 Nofollow 但能带来流量
- 前提条件：你需要有一个真实的播客内容（哪怕只有一集）
- 如果没有播客但想要外链，可以创建一个与你网站主题相关的播客

---

## 12. Spotify for Podcasters (podcasters.spotify.com)

**DA/DR**: DA99 | **费用**: 免费 | **类型**: 播客平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交播客 RSS Feed | https://podcasters.spotify.com | Nofollow | 高（品牌+流量） |

### 操作步骤

1. 访问 https://podcasters.spotify.com
2. 注册或登录 Spotify Creator 账号
3. 点击 **"Get Started"**
4. 粘贴你的播客 RSS Feed URL
5. Spotify 会发送一封验证邮件，包含 8 位验证码
6. 输入验证码完成验证
7. 填写播客详细信息：
   - **Category**（分类）
   - **Language**（语言）
...
8. 提交后等待处理（通常几小时，偶尔需要几天）

### 启用 RSS Feed 分发

- 登录后点击 **Settings** → **Availability**
- 滚动到 **RSS Distribution** 查看/启用你的 RSS Feed
- 这个 RSS Feed 可以用来提交到其他播客平台

### Tips

- Spotify 是全球第二大播客平台，DA99
- RSS Feed 必须符合严格的技术标准（格式、标签、字符编码）
- 链接是 Nofollow，但平台本身的流量和品牌价值极高
- 播客描述和节目笔记中可以放网站链接
- 如果你已有其他平台托管的播客，只需提交 RSS Feed 即可同步
- Spotify 还提供直接在平台上录制和托管播客的功能（免费）

---

## 13. Podbean (podbean.com)

**DA/DR**: DA80+ | **费用**: 免费/付费 | **类型**: 播客托管 + 目录

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交播客到目录 | https://www.podbean.com（页脚 "Submit your podcast"） | Nofollow | 中 |
| 播客描述内嵌链接 | 播客管理后台 | Nofollow | 低 |

### 操作步骤

**外部播客提交到 Podbean 目录：**

1. 访问 https://www.podbean.com
2. 滚动到页脚，点击 **"Submit your podcast"**
3. 系统跳转到登录页面
4. 注册或登录 Podbean 账号（免费账号即可）
5. 填写你的播客 RSS Feed URL
6. 点击 **"Submit"**
7. 提交成功后会显示 "View it" 链接

**注意：**
- Podbean 付费用户自动在 24 小时内加入目录
- Podbean 免费用户需要先验证账号（注册 15 天后可验证）

### Tips

- Podbean 链接主要是 Nofollow，不直接传递 SEO 权重
- 但可以在播客描述中嵌入网站链接，获得引流
- 播客描述中的链接锚文本要自然、与内容相关
- 如果只是为了外链，优先级不如 Apple/Spotify 高
- 但 Podbean 的独立播客页面可以被 Google 索引，间接帮助 SEO
- 免费账号有存储限制（5 小时），付费起步 $14/月

---

## 14. Podchaser (podchaser.com)

**DA/DR**: DA70+ | **费用**: 免费 | **类型**: 播客数据库 / 评论平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 添加播客 | https://www.podchaser.com/add | Nofollow | 中 |
| 认领播客 | https://www.podchaser.com/claim | Nofollow | 中 |
...
1. 注册 Podchaser 账号
2. 点击右上角头像 → **"+ Add a Podcast"**
3. 或直接访问 https://www.podchaser.com/add
4. 粘贴你的播客 RSS Feed URL
5. 点击 **"Submit Podcast"**
...
1. 找到你的播客页面
2. 点击 **"Is this your podcast?"** 或 **"Claim This Podcast"**
3. 选择验证方式：
   - **邮箱验证**：选择 "Verify via email"，点击 "Send email code"，检查收件箱
   - **Feed Token 验证**：选择 "Verify via feed"，复制 claim token，粘贴到你的播客某一集描述中，回到 Podchaser 点击 "Verify token"
4. 验证完成后获得播客管理权限
...
- 回复听众评论
- 自定义 URL
- 商品集成（Merch Integration）
- 播客徽章展示
- 更多管理功能

### Tips

- Podchaser 是最大的播客数据库之一，被称为"播客界的 IMDb"
- 链接主要是 Nofollow，但页面被 Google 索引，有品牌价值
- 认领播客后可以添加更多信息和链接
- 免费使用，无付费门槛
- 评论互动功能有助于建立播客品牌
...
## 15. Listen Notes (listennotes.com)

**DA/DR**: DA75+ | **费用**: 免费 | **类型**: 播客搜索引擎

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 提交播客 | https://www.listennotes.com/submit/ | Nofollow | 中 |
| 认领播客页面 | 播客页面 → PODCASTER 标签 | Nofollow | 中 |

### 操作步骤

**提交播客：**

1. 访问 https://www.listennotes.com/submit/
2. 提交方式二选一：
   - 粘贴 **iTunes/Apple Podcasts URL**
   - 粘贴 **RSS Feed URL**
3. 可选：填写邮箱地址（收到收录通知）
4. 如果播客已在数据库中，会立即返回页面 URL
5. 如果是新播客，团队在 12 小时内审核（通常几分钟甚至几秒）

**认领播客页面：**

1. 找到你的播客页面
2. 点击 **PODCASTER** 标签
3. 点击 **"Claim this podcast"** 按钮
4. 如果你的账号邮箱与 RSS Feed 中的邮箱匹配，可以即时认领
5. 如果邮箱不匹配：
   - 方法 A：在 Settings 中修改邮箱为 RSS Feed 中的邮箱
   - 方法 B：用 RSS Feed 中的邮箱发送确认邮件
   - 方法 C：在播客描述中添加 "Listen Notes" 字样，然后发邮件给团队

### Tips

- Listen Notes 号称"最受欢迎的播客搜索引擎"
- 提交后会被 Listen Notes 网站和 API 合作伙伴的应用中展示
- 联系邮箱：hello@listennotes.com
- 播客页面会被 Google 索引，有助于品牌 SEO
- 即使不手动提交，爬虫最终也会发现公开播客，但手动提交可加速
- 播客主页面可以包含网站链接和社交媒体链接

---

## 16. Player.fm (player.fm)

**DA/DR**: DA70+ | **费用**: 免费 | **类型**: 播客目录 / 播放器

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 导入播客 RSS Feed | https://player.fm/importer/feed | Nofollow | 中 |
| 通过托管平台提交 | 各托管平台的 Distribution 设置 | Nofollow | 中 |

### 操作步骤

**方式一：直接通过 RSS Feed 导入**

1. 注册或登录 Player.fm 账号
2. 访问 https://player.fm/importer/feed
3. 输入你的播客 RSS Feed URL
4. 点击 **"Import feed"**
5. Player.fm 立即接收播客，但搜索结果中出现可能需要最多 24 小时

**方式二：通过播客托管平台提交（如 Podbean、Buzzsprout、Libsyn）**

1. 登录你的托管平台账号
2. 进入 **Podcast Dashboard** → **Distribution** → **Podcast Apps**
3. 找到 Player FM 图标，点击 **"+"**
4. 确认播客符合条件，勾选复选框
5. 同意 Player FM 条款
6. 点击 **"Submit To Player FM"**

### Tips

- 提交后 Player.fm 立即接收，但搜索中出现需 24 小时
- 链接主要是 Nofollow
- Player.fm 也可以通过 https://player.fm/add 手动添加播客
- 如果已在 Apple Podcasts 等平台上，Player.fm 可能已自动收录
- 可以认领已有列表以获得评论通知等功能

---

## 17. Castbox (castbox.fm)

**DA/DR**: DA65+ | **费用**: 免费 | **类型**: 播客目录 / 播放器

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 认领播客所有权 | https://castbox.fm/podcasters-tools/ → Creator Studio | Nofollow | 中 |

### 操作步骤

1. 注册 Castbox 账号
2. 进入 **Creator Studio**（创作者工作室）
3. 点击 **"Channels"** 标签下的 **"Claim Ownership"** 按钮
4. 在弹窗中粘贴你的 RSS Feed URL
5. 输入 RSS Feed 中关联的邮箱地址
6. 点击 **"Submit"**
7. Castbox 发送验证邮件，点击邮件中的链接完成认领
8. 认领完成后进入 Creator Studio 管理页面
9. 可关联社交媒体账号到你的 Castbox 频道

### Tips

- **Castbox 会自动从 Apple Podcasts 等平台抓取播客**，无需手动提交
- 上述流程主要是"认领所有权"而非"提交新播客"
- 如果你的播客已在 Apple Podcasts 上，Castbox 很可能已自动收录
- 认领后可以管理频道、查看数据分析
- 如果播客确实未被收录，可联系 podcaster@castbox.fm 请求添加
- 链接主要是 Nofollow
- 可以申请 Featured（推荐位），通过 Creator Studio 或联系团队

---

## 18. Fandom (fandom.com)

**DA/DR**: DA95 | **费用**: 免费 | **类型**: Wiki 平台（用户生成内容）

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 创建新 Wiki 社区 | https://community.fandom.com/wiki/Special:CreateNewWiki | Nofollow | 中（高 DA 信号） |
| 在现有 Wiki 中添加外链 | 相关主题的 Wiki 编辑页面 | Nofollow | 中 |

### 操作步骤

**方式一：创建新 Wiki 社区**

1. 注册并验证 Fandom 账号（邮箱验证）
2. 点击左侧导航菜单 → **"Start A Wiki"**
3. 或直接访问 Wiki 创建表单
4. 填写创建表单：
   - **Wiki 名称**（建议使用常见关键词，利于 SEO）
   - **Wiki URL/子域名**（如 yourwiki.fandom.com）
   - **Wiki 描述**（简短介绍社区主题）
   - **Hub 分类**：Games / Movies / Comics / Books / TV / Music / Lifestyle
   - **Language**（语言选择）
5. 选择主题模板
6. 创建成功后开始编辑内容

**方式二：在现有 Wiki 页面中添加外链**

1. 找到与你网站主题相关的 Fandom Wiki
2. 点击页面上的 **"Edit"** 按钮
3. 选中要添加链接的文本
4. 点击工具栏的链接按钮
5. 选择 **"External link"**
...
- DA95 是极高的域名权重，即使 Nofollow 也有信号价值
- Google 2019 年后将 Nofollow 作为"提示"而非"指令"，高权重 Nofollow 链接仍有价值
- **外链默认带 rel="nofollow"**，无法移除
- 创建 Wiki 之前先搜索是否已有相同主题的社区，避免重复
- 需遵守 Fandom 的使用条款和社区创建政策
- Wiki 必须是公开可编辑的、自由授权的
- 在现有 Wiki 添加外链时，必须确保链接与页面内容相关且有价值
- 纯粹为了外链而添加不相关链接会被管理员删除
- 建议在与你行业相关的 Wiki 中贡献有价值的内容，同时自然地引用你的网站

---

## 19. Miraheze (miraheze.org)

**DA/DR**: DA60+ | **费用**: 免费 | **类型**: 免费 Wiki 托管平台

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 申请创建新 Wiki | https://meta.miraheze.org/wiki/Special:RequestWiki | Nofollow | 中 |
| 在 Wiki 页面中添加外链 | 创建的 Wiki 编辑页面 | Nofollow（默认） | 中 |

### 操作步骤

1. 访问 https://miraheze.org 注册账号
2. 访问 https://meta.miraheze.org/wiki/Special:RequestWiki 提交 Wiki 申请
3. 填写申请表单：
   - **Subdomain**（子域名）：你的 Wiki 将在 `yourname.miraheze.org`
   - **Wiki Name**（Wiki 名称）
   - **Language**（语言）
   - **Category**（分类）
   - **Private Wiki**（是否私有，勾选后仅限授权用户访问）
   - **Reason**（申请理由）：详细说明 Wiki 的用途、范围和主题
4. 提交后由 Wiki Reviewer（审核员）审核
5. 审核通过后 Wiki 即刻创建
6. 在 Wiki 页面中可添加外部链接到你的网站

### 申请要点（提高通过率）

- 清楚描述 Wiki 的目的和范围
- 确保不违反 Miraheze Content Policy
- 确认不存在相同主题的 Wiki（可在 Wiki Gazetteer 查看）
- 子域名要与 Wiki 主题相关

### Tips

- 100% 免费，无广告
- 基于 MediaWiki（与维基百科同一引擎），提供 300+ 扩展和 25+ 皮肤
- 可以使用自定义域名（需额外配置）
- Wiki 页面被 Google 索引，借助 miraheze.org 的 DA 获得 SEO 收益
- 外部链接默认 Nofollow（MediaWiki 默认行为）
- 适合创建与你的业务/产品相关的知识库或资源中心
- 如果你的网站涉及某个特定领域，可以创建该领域的 Wiki 百科
- 需要持续维护，长期不活跃的 Wiki 可能被关闭

---

## 20. Qwoted (qwoted.com)

**DA/DR**: DR73 | **费用**: 免费/$99/月 | **类型**: 记者-专家匹配平台（类 HARO）

### 可用方法

| 方法 | 入口 | 链接属性 | SEO价值 |
|------|------|----------|---------|
| 专家 Profile（含网站链接） | https://www.qwoted.com/ → Sign up | Dofollow（Profile 页） | 中 |
| 回复记者 Source Request | 登录后匹配的媒体请求 | Dofollow（文章内引用链接） | 高 |
...
2. 点击 **"Sign up"**
3. 选择 **"I'm looking to earn media"**（寻求媒体曝光）
4. 填写：First Name、Last Name、Email 等
5. 检查收件箱，点击验证链接激活账号

**设置专家 Profile：**

1. 登录后点击右上角你的名字 → **"My Profile"**
2. 完善以下信息：
   - **Profile Photo**（专业头像，有照片的 profile 被记者关注的概率高 65%）
   - **Bio / 简介**（突出你的专业领域和经验）
   - **Website URL**（你的网站链接 — 这是外链来源之一）
   - **Social Media Links**（社交媒体链接）
   - **Expert Topics**（专家话题 — 最重要！决定系统推送哪些媒体机会给你）
3. **不要勾选** "Hide from search engines"（保持公开可被 Google 索引）

**回复 Source Request（获得高质量外链的核心方法）：**

1. 设置好 Expert Topics 后，系统会通过邮件推送匹配的记者请求
2. 查看请求详情（记者来源、文章主题、截止时间）
3. 撰写专业、有见地的回复（250-500 字）
4. 如果被选中，记者会在文章中引用你的观点并附上你网站的链接

### 定价

| 方案 | 费用 | 功能 |
|------|------|------|
| Free | $0 | 每月回复 2 次，收到请求有 2 小时延迟 |
| Paid | $99/月 | 无限回复，即时收到请求 |

### Tips

- Qwoted 是 HARO（已被关闭）的最佳替代品之一
- 通过记者请求获得的外链通常是 **Dofollow**，来自高权重媒体网站
- 这些外链的 SEO 价值极高（来自新闻网站、行业媒体等）
- 免费版每月只能回复 2 次，但足以起步
- 回复质量决定成功率：要专业、有数据支撑、有独特见解
- 速度很重要：记者通常在发布请求后 24-48 小时内选择来源
- 付费版 $99/月 解锁无限回复和即时推送，适合长期使用
- 专家 Profile 本身也会被 Google 索引，提供额外的品牌曝光
- 比起目录提交，Qwoted 的外链质量通常更高，因为来自真实的新闻报道

---

# 汇总对比表

| # | 网站 | DR/DA | 费用 | 链接属性 | 难度 | 推荐优先级 |
|---|------|-------|------|----------|------|-----------|
| 1 | Alternative.me | DR73 | 免费 | Dofollow | 低 | ★★★★★ |
| 2 | SiteLike.org | DR71 | 免费 | Dofollow | 极低 | ★★★★★ |
| 3 | AITools.inc | DR67 | 免费/$129 | 未确认/Dofollow | 低 | ★★★★ |
| 4 | FutureTools | DR64 | 免费 | Dofollow | 低 | ★★★★ |
| 5 | ToolsFine | DR57 | 免费/$100+ | Dofollow | 低 | ★★★ |
| 6 | Ben's Bites | DR53 | 免费 | Nofollow | 中 | ★★★ |
| 7 | BAI.tools | DR48 | 免费/$19.9+ | Nofollow/Dofollow | 低 | ★★★ |
| 8 | TwelveTools | DR80 | 免费(需互链) | Dofollow | 中 | ★★★★★ |
| 9 | ToolsDirectoryOnline | 未标注 | 免费 | Dofollow(推测) | 极低 | ★★★ |
| 10 | 10015.io | DR50 | 免费 | Dofollow(推测) | 极低 | ★★★ |
| 11 | Apple Podcasts | DA100 | 免费 | Nofollow | 高 | ★★★★（需播客） |
| 12 | Spotify Podcasters | DA99 | 免费 | Nofollow | 高 | ★★★★（需播客） |
| 13 | Podbean | DA80+ | 免费 | Nofollow | 中 | ★★★ |
| 14 | Podchaser | DA70+ | 免费 | Nofollow | 中 | ★★★ |
| 15 | Listen Notes | DA75+ | 免费 | Nofollow | 低 | ★★★ |
| 16 | Player.fm | DA70+ | 免费 | Nofollow | 低 | ★★★ |
| 17 | Castbox | DA65+ | 免费 | Nofollow | 低 | ★★ |
| 18 | Fandom | DA95 | 免费 | Nofollow | 中-高 | ★★★★ |
| 19 | Miraheze | DA60+ | 免费 | Nofollow | 中 | ★★★ |
| 20 | Qwoted | DR73 | 免费/$99月 | Dofollow（媒体引用） | 高 | ★★★★★ |

## 执行建议

### 第一梯队（立即执行，5 分钟搞定）
1. **SiteLike.org** — 无需注册，Dofollow，5 分钟获得 DR71 外链
2. **ToolsDirectoryOnline** — 无需注册，只要 URL，极简
3. **10015.io** — 输入 URL 自动填表，极简

### 第二梯队（注册后快速提交）
4. **Alternative.me** — 注册后提交，Dofollow，DR73
5. **FutureTools** — 免费表单提交，DR64
6. **ToolsFine** — 免费提交 + 互链可加速
7. **TwelveTools** — DR80 高权重，但需在网站放徽章

### 第三梯队（AI 工具付费快车道）
8. **AITools.inc** — 免费排队太久，$129 快速通道
9. **BAI.tools** — $19.9-29.9 获得 Dofollow

### 第四梯队（播客策略 — 需要制作播客内容）
10. **Apple Podcasts** + **Spotify** + **Listen Notes** + **Podchaser** + **Player.fm** + **Podbean** + **Castbox**
- 制作一个与网站主题相关的播客（哪怕只有 1-2 集），然后批量提交到以上 7 个平台
- 虽然是 Nofollow，但 DA95-100 的平台 + 品牌曝光价值极高

### 第五梯队（内容策略 — 需要持续投入）
11. **Fandom** — 创建相关主题 Wiki，DA95 信号价值
12. **Miraheze** — 创建知识库 Wiki
13. **Qwoted** — 回复记者请求获取高质量 Dofollow 媒体外链（最高 ROI）
14. **Ben's Bites** — 提交工具 + 社区互动


---

# 附录四：Profile 外链公开可见性验证（2026-03-25）

> 验证方法：用 WebSearch 找到每个网站的真实公开 profile 页面，用 WebFetch 确认外链是否对外可见。
> 很多网站虽然允许你在设置里填写 URL，但 profile 页面上对其他人/搜索引擎不可见 = 无 SEO 价值。
...
| 网站 | 示例 Profile | 外链展示方式 |
|------|-------------|-------------|
| soundcloud.com | /用户名 | 最多10个外链，公开可见 |
| quora.com | /profile/用户名 | bio和credential中可加链接 |
| pexels.com | /@用户名/ | website URL + 社交链接 |
| deviantart.com | /用户名 | About/bio/Social Links |
| giphy.com | /用户名 | 频道页显示网站链接 |
| linktr.ee | /用户名 | 整个页面就是外链集合 |
| gitlab.com | /sytses | website_url + 社交账号 |
| codepen.io | /用户名 | 社交链接 + 3个自定义链接 |
| provenexpert.com | /en-us/公司名/ | "Visit Website"链接 |
| marketplace.whmcs.com | /group/名称 | "Visit Website"链接（需创建group） |
| upwork.com | /freelancers/用户名 | portfolio/website链接 |
| discogs.com | /user/用户名 | Homepage链接字段 |
| artstation.com | /用户名 | 外部网站链接+社交图标 |
| redbubble.com | /people/用户名/shop | 社交链接在About区域 |
| hub.docker.com | /u/用户名 | website链接字段（house图标） |
| indiegogo.com | /en/profile/用户名 | "outside links"字段 |
| orcid.org | /0000-0002-xxxx-xxxx | 研究者网站链接 |
| reverbnation.com | /艺术家名 | 个人网站+社交链接 |
| 500px.com | /用户名 | About页+照片描述中超链接 |
| wellfound.com (angel.co) | /p/用户名 | 社交媒体+网站链接 |
| gumroad.com | 用户名.gumroad.com | creator profile外链 |
| ko-fi.com | /用户名 | 最多15个社交链接+自定义URL |
| VS Marketplace | /items?itemName=xxx | Resources区域外部链接 |
| readthedocs.org | /profiles/用户名/ | GitHub/Twitter/Blog等多链接 |
| loop.frontiersin.org | /people/ID/bio | 研究者机构和链接 |
| bloglovin.com | /blogs/博客名-ID | 链接回原始博客网站 |
| gitbook.com | 用户名.gitbook.io/项目 | 公开文档含任意外链 |
| zazzle.com | /store/用户名 | 社交链接在About页 |
| spreaker.com | /podcast/名称-ID | Website字段公开可见 |
| instructables.com | /member/用户名/ | 网站+YouTube+Instagram+GitHub |
| creativemarket.com | /用户名 | About tab+社交链接 |
| arduino.cc | forum/u/用户名 | Website字段（有已知bug） |
| awwwards.com | /用户名/ | 提交网站的live link |
| dribbble.com | /用户名 | 网站链接+社交媒体 |
| buzzsprout.com | /ID | 播客页社交链接（需付费） |

## ⚠️ 条件有效（有限制或门槛）

| 网站 | 限制条件 |
|------|----------|
| addons.mozilla.org | 必须发布已审核通过的add-on，否则profile返回404 |
| kickstarter.com | profile页不被搜索引擎索引 |
| meetup.com | 仅Group页面有社交链接，个人profile无网站字段 |
| moz.com | 需声望分>=5才能添加网站链接 |
| phpbb.com/forum.filezilla-project.org | 需登录才能查看profile，搜索引擎无法索引 |
| buzzfeed.com | 仅限Twitter/Facebook，无自定义URL |
| flipboard.com | bio中链接显示为纯文本，不可点击 |

## ❌ 无效（外链不公开可见，无SEO价值）

| 网站 | 原因 |
|------|------|
| **theverge.com** | 使用Coral评论系统，无用户profile页面 |
| **sourceforge.net** | 用户profile只有项目列表，无网站字段 |
| **ted.com** | profile极简（名字+头像），无网站字段，需登录查看 |
| **change.org** | profile只有姓名/城市/Twitter，无自定义网站字段 |
| **calameo.com** | 设置能填网站URL但公开profile页不显示 |
| **vox.com** | 无用户profile系统，只有文章byline |
| **academia.edu** | **官方确认"Only you can see your external links page"** |
| **coursera.org** | profile不支持外部网站链接，只展示课程完成情况 |
| **evernote.com** | 无公开profile页面，笔记需登录查看 |
| **netvibes.com** | **2025年6月已彻底关闭** |
| **peatix.com** | organizer profile无website URL字段 |
| **forum.unity.com** | 迁移到discussions.unity.com后无website字段 |
| **seekingalpha.com** | **官方要求删除外部链接引用，禁止推广外站** |

## 结论

23% 的 "Profile link" 网站实际上**无法提供公开可见的外链**。
按此比例推算，1207个High DA Profile站中约有 **~280个** 的外链标注是误导性的。

建议：对剩余930个未验证的站点继续做同样的验证。
